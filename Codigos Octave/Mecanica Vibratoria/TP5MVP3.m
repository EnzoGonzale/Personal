...
x0=zeros(1,3); x0(1)=1;
v0=zeros(1,3);
M=zeros(3,3); M(1,1)=m; M(2,2)=M(3,3)=2*m;
K=zeros(3,3); K(1,1)=K(2,2)=3*k; K(1,2)=K(2,1)=-2*k; K(3,2)=K(2,3)=-k; K(3,3)=k;
#Fin de Variables
...
[x_t, Xn, X, w, wd]=MultiplesGradosLivertad(z, M, K, x0, v0, t, dt, F);
